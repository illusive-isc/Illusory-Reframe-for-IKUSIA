...
namespace jp.illusive_isc.IllusoryReframe.IKUSIA.Mizuki {
	public class Base : BaseAbstract {
		...
		internal override void ParticleOptimize() {
			...
			SetMaxParticle("Advanced/butterfly/world/target_constraint/cyou/idolParticle/idolParticle2", 20);
			SetMaxParticle("Advanced/butterfly/world/target_constraint/cyou/idolParticle/idolParticle2/idolParticle3", 20);
